...
build:
	docker build -f Dockerfile -t itsffr-docker-delivered/tools/e2e-testing-manager-api:1.1.0 --platform=linux/amd64 .

tag:
	docker tag itsffr-docker-delivered/tools/e2e-testing-manager-api:1.1.0 jfrog-artifactory.steelhome.internal/itsffr-docker-delivered/tools/e2e-testing-manager-api:1.1.0

push:
	docker push jfrog-artifactory.steelhome.internal/itsffr-docker-delivered/tools/e2e-testing-manager-api:1.1.0

run_docker:
	docker run -i --rm -p 60000:60000 --name cypress-api  itsffr-docker/tools/e2e-testing-manager-api:1.1.0
