...
public class ThrowableMapper implements ExceptionMapper<Throwable> {
    ...
    public Response toResponse(Throwable exception) {
        ...
        if (exception instanceof CustomException customException && StringUtils.isNotBlank(customException.getTitle())) {
            ...
            exceptionResponse = new ExceptionResponse(customException.getStatus(),
            ...
            exceptionResponse = new ExceptionResponse(status.getStatusCode(),
                                                      "internal-error",
