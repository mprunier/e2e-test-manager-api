...
public final class EnvironmentVariableResponseMapper {
    ...
    private static EnvironmentVariableResponse buildEnvironmentVariableResponse(EnvironmentVariableEntity entity) {
        return EnvironmentVariableResponse.builder()
                                          .id(entity.getId())
                                          .description(entity.getDescription())
                                          .name(entity.getName())
                                          .defaultValue(Boolean.TRUE.equals(entity.getIsHidden()) ? hideVariable() : entity.getDefaultValue())
                                          .isHidden(entity.getIsHidden())
                                          .build();

    }

    public static List<EnvironmentVariableResponse> buildEnvironmentVariableResponses(List<EnvironmentVariableEntity> entities) {
