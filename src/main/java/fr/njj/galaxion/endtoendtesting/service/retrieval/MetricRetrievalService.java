...
public class MetricRetrievalService {
    ...
    @Transactional
    public List<MetricsEntity> getAllByEnvironmentSince(
            long environmentId,
            LocalDate since) {
    ...
    @Transactional
    public Optional<MetricsEntity> getOptionalLastMetrics(
            long environmentId) {
        return metricRepository.findLastMetrics(environmentId);
    }

    @Transactional
    public Optional<MetricsEntity> getOptionalLastMetricsWithAllTestsRun(
            long environmentId) {
