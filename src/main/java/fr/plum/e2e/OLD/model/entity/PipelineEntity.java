...
public class PipelineEntity extends PanacheEntityBase {
  ...
  private WorkerStatus status = WorkerStatus.IN_PROGRESS;
  ...
  public boolean hasTestIdsFilter() {
    return false; //  configurationTestIdsFilter != null && !configurationTestIdsFilter.isEmpty();
  }

  public boolean hasFilesFilter() {
    return false; // filesFilter != null && !filesFilter.isEmpty();
  }
}
