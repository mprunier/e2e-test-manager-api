package fr.plum.e2e.manager.core.domain.usecase.synchronization.process;
...
import fr.plum.e2e.manager.core.domain.usecase.synchronization.process.dto.ConfigurationChanges;
