package fr.plum.e2e.manager.core.infrastructure.secondary.external.gitlab.client;

import fr.plum.e2e.manager.core.infrastructure.secondary.external.gitlab.domain.exception.GitlabExceptionMapper;
import fr.plum.e2e.manager.core.infrastructure.secondary.external.gitlab.domain.request.PipelineRequest;
import fr.plum.e2e.manager.core.infrastructure.secondary.external.gitlab.domain.response.GitlabProjectDetail;
