package fr.plum.e2e.manager.core.infrastructure.secondary.external.webclient.cypress.mapper;
...
import static fr.plum.e2e.manager.core.infrastructure.secondary.external.webclient.cypress.constant.CypressConstant.CYPRESS_SUITE_FUNCTION_NAME;
import static fr.plum.e2e.manager.core.infrastructure.secondary.external.webclient.cypress.constant.CypressConstant.CYPRESS_TAGS_PARAM_NAME;
import static fr.plum.e2e.manager.core.infrastructure.secondary.external.webclient.cypress.constant.CypressConstant.CYPRESS_TEST_FUNCTION_NAME;
import static fr.plum.e2e.manager.core.infrastructure.secondary.external.webclient.cypress.constant.CypressConstant.CYPRESS_VARIABLES_PARAM_NAME;
...
import fr.plum.e2e.manager.core.infrastructure.secondary.external.webclient.cypress.exception.BuildFileConfigurationException;
import fr.plum.e2e.manager.core.infrastructure.secondary.external.webclient.cypress.exception.SuiteShouldBeNotContainsSubSuiteException;
