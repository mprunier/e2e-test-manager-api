...
import static fr.plum.e2e.manager.core.infrastructure.secondary.external.webclient.cypress.constant.CypressConstant.END_TEST_JS_PATH;
import static fr.plum.e2e.manager.core.infrastructure.secondary.external.webclient.cypress.constant.CypressConstant.END_TEST_TS_PATH;
import static fr.plum.e2e.manager.core.infrastructure.secondary.external.webclient.cypress.constant.CypressConstant.SCREENSHOT_EXTENSION;
import static fr.plum.e2e.manager.core.infrastructure.secondary.external.webclient.cypress.constant.CypressConstant.SCREENSHOT_PATH;
