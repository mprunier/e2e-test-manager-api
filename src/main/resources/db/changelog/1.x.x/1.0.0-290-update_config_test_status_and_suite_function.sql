...
-- changeset mprunier:1.0.0-290-update_config_test_status_and_suite_function.sql endDelimiter:go
...
BEGIN
    ...
    SELECT succeeded, failed, in_progress, newer, skipped, canceled
    INTO succeeded_count, failed_count, in_progress_count, new_count, skipped_count, canceled_count
    FROM test_status_counts;

    -- Mise à jour du statut de configuration_suite en fonction des décomptes
